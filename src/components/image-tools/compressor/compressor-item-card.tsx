...
export function CompressorItemCard({
  ...
  return (
    <div className="rounded-2xl border border-[#EAEAE5] bg-white p-4 sm:p-5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 shadow-xs transition-all hover:border-[#BEBDB9]">
      ...
      <div className="flex items-center gap-3 self-end sm:self-center shrink-0 w-full sm:w-auto justify-between sm:justify-end border-t sm:border-t-0 pt-3 sm:pt-0 border-[#EAEAE5]">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            type="button"
            onClick={() => onCompare(item)}
            className="h-8 px-2.5 rounded-xl border border-[#EAEAE5] bg-white text-xs font-semibold text-[#111111] hover:bg-[#F5F4EE] active:scale-95 transition-all inline-flex items-center gap-1"
          ...
          <button
            ...
            className="h-8 px-3 rounded-xl bg-[#111111] text-xs font-semibold text-white hover:bg-[#262626] active:scale-95 disabled:opacity-50 transition-all inline-flex items-center gap-1.5 shadow-2xs"
          >
